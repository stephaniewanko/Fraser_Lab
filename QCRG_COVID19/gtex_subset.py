...
#import GTEX
GTEX = pd.read_csv('/wynton/group/fraser/swankowicz/COVID19/GTEx_Analysis_2017-06-05_v8_RNASeQCv1.1.9_gene_median_tpm.gct', comment='#', sep='\t', header=1, low_memory=False)

#import gene lists
drugs = pd.read_csv('/wynton/group/fraser/swankowicz/COVID19/drug_targets.txt', header=None)
genes = pd.read_csv('/wynton/group/fraser/swankowicz/COVID19/final_targets.txt', header=None)
...
gtex_subset = GTEX[['Description', 'Lung']]
